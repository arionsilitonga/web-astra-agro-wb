	...
	<div class="body2 row">
		<div class="col-8 row">
				<?php if ($tr_wb['transactiontype']=='TBS External'){ ?>
					<div class="label col-6">&nbsp;</div><div class="isi col-9"> <?=$tr_wb['nama_barang'] ?? ''.' EKSTERNAL'?></div>	
					<div class="label col-3"></div><div class="isi col-9"><?=$tr_wb['nama_supplier'] ?? ''+$tr_wb['customername']?></div>
				<?php }else {?>
					<div class="label col-6">&nbsp;</div><div class="isi col-9"> <?=$tr_wb['nama_barang'] ?? ''.$tr_wb['transactiontype']?></div>	
