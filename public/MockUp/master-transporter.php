...
$tableData = [
	['PT.TBPP', 'PT.TRI BHAKTI PRIMA PERKASA', 'Kecamatan Sei Manding KEBUN RIAU A2', '022-23134', 'Y', 'EXTERNAL', ''],
	['SAI1', 'PT SAWIT ASAHAN INDAH', 'Kecamatan Sei Manding KEBUN RIAU A2', '0234-343243', 'Y', 'INTERNAL', ''],
];
...
<head>
	...
	<title><?= $title ?> | idge - PT ASTRA AGRO LESTARI Tbk</title>
					...
					<ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item menu-open">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="./master-transporter.php" class="nav-link active">
										<i class="nav-icon fas fa-list-alt"></i>
										<p>Transporter</p>
									</a>
								</li>
